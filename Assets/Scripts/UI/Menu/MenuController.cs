...
public class MenuController : MonoBehaviour
{
    ...
    private LevelDescriptionCollection _levelStatisticsSaver;
    private SaverBase<LevelStatisticsArray> _levelStatisticsCollection;
    ...
    private void Construct(
        ...
        SaverBase<LevelStatisticsArray> levelStatisticsSaver,
        SessionData sessionData)
    {
        _sessionData = sessionData;
        _levelStatisticsCollection = levelStatisticsSaver;
        _levelStatisticsSaver = levelDescriptionCollection;
    ...
    private void ShowListOfLevels()
    {
        ...
        {
            if (_levelStatisticsSaver.TryGetDescription(levelId, out LevelDescription description))
            {
                if (_levelStatisticsCollection.Instance.TryGetStatistics(levelId, out LevelStatistics statistics))
                {
